const csData = [
  ...
  },
  {
    ...
    "answer": "프로세스는 **실행 중인 프로그램**입니다. 프로그램이 메모리에 적재되어 CPU를 할당받아 실행되는 상태를 말합니다.\r\n\r\n프로세스는 다음을 포함합니다:\r\n- **코드 영역**: 실행할 프로그램 코드\r\n- **데이터 영역**: 전역 변수, 정적 변수\r\n- **힙 영역**: 동적 할당 메모리\r\n- **스택 영역**: 함수 호출, 지역 변수\r\n- **PCB**: 프로세스 상태 정보\r\n\r\n각 프로세스는 독립적인 주소 공간을 가지며, OS가 자원 할당 및 스케줄링의 단위로 관리합니다.",
    "references": [
      {
  ...
  },
  {
    ...
    "answer": "**MMU와 TLB는 CPU 칩 내부에 위치**합니다.\r\n\r\n**물리적 위치**:\r\n```\r\n+----------------------------------+\r\n|              CPU                 |\r\n|  +--------+     +---------+      |\r\n|  | Core   |---->|   MMU   |----->| 메모리 버스\r\n|  |        |     |  (TLB)  |      |\r\n|  +--------+     +---------+      |\r\n|                                  |\r\n|  +--------+     +---------+      |\r\n|  | Core   |---->|   MMU   |----->|\r\n|  |        |     |  (TLB)  |      |\r\n|  +--------+     +---------+      |\r\n+----------------------------------+\r\n```\r\n\r\n**구조적 특징**:\r\n\r\n1. **MMU**:\r\n   - 각 CPU 코어에 통합\r\n   - CPU 파이프라인의 일부\r\n   - 메모리 접근 전 주소 변환\r\n\r\n2. **TLB**:\r\n   - MMU 내부에 위치\r\n   - SRAM으로 구현 (빠른 속도)\r\n   - 코어별 독립적 TLB 존재\r\n   - 일부 시스템에서 L2 TLB 공유\r\n\r\n**계층 구조**:\r\n```\r\nL1 ITLB (명령어) - 코어별\r\nL1 DTLB (데이터) - 코어별\r\nL2 TLB (통합) - 코어별 또는 공유\r\n```\r\n\r\nCPU와 메모리 사이의 모든 접근은 MMU를 거칩니다.",
    "references": [
      {
